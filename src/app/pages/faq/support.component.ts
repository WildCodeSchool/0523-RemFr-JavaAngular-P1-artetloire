...
export class SupportComponent {
  faqQuestion: Faq[] = [
    ...
    {
      title:
        "Existe-t-il des tarifs réduits pour les étudiants et les personnes âgées ?",
    ...
    {
      title:
        "Est-ce que les musées sont accessibles aux personnes à mobilité réduite ?",
    ...
    {
      title:
        "Comment puis-je me tenir informé des expositions temporaires et des événements spéciaux dans les musées ?",
